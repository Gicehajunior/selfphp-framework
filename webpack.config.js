        ...
        plugins: [
            new CopyWebpackPlugin({
                patterns: [ 
                    ...
                    { from: './node_modules/bootstrap-datepicker/dist/css/*.css', to: 'assets/datepicker/css/[name][ext]' },
                    { from: './node_modules/bootstrap-datepicker/dist/js/*.js', to: 'assets/datepicker/js/[name][ext]' },
                    ...
                    { from: './node_modules/select2/dist/css/*.css', to: 'assets/select/css/[name][ext]' },
                    { from: './node_modules/select2/dist/js/*.js', to: 'assets/select/js/[name][ext]' },
                    ...
                    { from: './node_modules/@popperjs/core/dist/umd/*.js', to: 'assets/popper/js/[name][ext]' },
